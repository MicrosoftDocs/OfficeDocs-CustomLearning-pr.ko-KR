...
---
# <a name="microsoft-365-learning-pathways-content-updates-for-april"></a>Microsoft 365 4월용 학습 경로 콘텐츠 업데이트
...
## <a name="april-2020-content-updates"></a>2020년 4월 콘텐츠 업데이트
 현재 이벤트에 대한 응답으로 2020년 4월 콘텐츠 업데이트는 조직에서 원격 작업을 사용하도록 설계된 학습 재생 목록 및 리소스를 제공합니다. 원격으로 작업 재생 목록 집합이 새로 추가되었습니다. 특히 Teams 모임의 경우 Microsoft Teams 콘텐츠를 대폭 업데이트하고, 웹용 Office 재생 목록 집합을 새로 추가하고, 새 Microsoft Forms 자산을 추가했습니다. 또한 업데이트의 일부로 관리자를 위한 원격 작업 리소스 목록도 제공했습니다.  
 
 콘텐츠 업데이트가 적용되는 방법 및 콘텐츠 업데이트를 관리하는 방법에 대한 자세한 내용은 [Manage Content Updates를 참조하세요.](custom_contentupdatesmanage.md) 다음은 2020년 4월 학습 경로 Microsoft 365 업데이트 목록입니다. 

### <a name="office-365-was-rebranded-to-microsoft-365"></a>Office 365 Microsoft 365
Office 365 다시 브랜드가 Microsoft 365. 이름 변경은 학습 경로 Microsoft 365 반영됩니다. 
...
- 작업 파일 저장
- 고급 대체
##### <a name="best-practices-for-collaborating-with-office-365-6-new-assets"></a>새로운 자산 6개와의 공동 Office 365 모범 사례
- 시작하기
- 공유
- 공동 작성자
- 파일 채팅
...
### <a name="teams-9-new-assets6-updated-assets"></a>Teams(새 자산 9개/업데이트된 자산 6개)
콘텐츠에 대한 다양한 업데이트가 Teams 있습니다. 
#### <a name="collaborate-in-teams-and-channels-1-new1-updated-asset"></a>팀 및 채널에서 공동 작업(1개 신규/1개 업데이트된 자산)
- 비공개 채널 만들기 및 사용(신규)
- 채널 표시 또는 숨기기(업데이트)
#### <a name="start-chats-and-calls-2-new1-updated"></a>채팅 및 통화 시작(2개 신규/1 업데이트)
- 채팅 시작 및 고정(신규)
- 채팅 숨기기, 메시지 삭제(신규)
- 전화 걸기(업데이트)
#### <a name="explore-apps-and-tools-1-new"></a>앱 및 도구 탐색(1개 새로운 기능)
- 앱 사용(신규)
#### <a name="work-with-posts-and-messages"></a>게시물 및 메시지 작업
- 여러 채널에 메시지 게시(신규)
#### <a name="manage-meetings-3-new4-updated-assets"></a>모임 관리(업데이트된 3개/업데이트된 자산 3개)
- Teams 모임 참가(신규)
- 모임 시작으로 인스턴트 모임 만들기(업데이트)
- 채널에서 만나기(신규)
- 모임 관리(신규)
- 모임 중에 화면 표시(업데이트)
- 슬라이드 PowerPoint 표시(업데이트)
- 모임 중에 Teams 이동(업데이트)
#### <a name="work-with-post-and-messages-1-new"></a>게시물 및 메시지 작업(새로 추가된 1개)
- 여러 채널에 메시지 게시(신규)

### <a name="office-for-the-web"></a>웹용 Office
웹용 Office 사용자와 공유하고 공동 작업하려는 시나리오에 대한 재생 목록 집합을 웹용 Office. 이 콘텐츠 집합은 Google G Suite에서 다른 조직으로 전환하는 조직에도 Microsoft 365.
#### <a name="get-started-5-new-assets"></a>시작(새 자산 5개)
- 시작하기
- 검색을 사용하여 찾기
- 새 문서 만들기
- 직장으로 돌아가기
- 권장 파일
#### <a name="outlook-for-the-web"></a>Outlook 대한 웹 사이트
- 웹용 Outlook 대해 알아가기
- 전자 메일에 회신 만들기
- 받은 편지함 구성
- 서명 및 자동 회신 만들기
...
#### <a name="forms-4-new-assets"></a>양식(새 자산 4개) 
- 양식 만들기 
- 양식 공유 
- 양식의 결과 보기 
...
- [Microsoft Teams의 모임 및 회의](/microsoftteams/deploy-meetings-microsoft-teams-landing-page)
- [원격 작업자를 사용하여 원격 작업자 Microsoft Teams](/microsoftteams/support-remote-work-with-teams)
